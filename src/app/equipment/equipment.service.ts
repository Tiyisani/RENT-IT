...
get profile(){
  ...
  fetchEquipment(){
   ...
   return this.authService.token.pipe(take(1),
    ...
    (`https://ionic-cab1.firebaseio.com/offered-equipment.json?auth=${token}`)
    })
    ,map(resData => {
  ...
  getEquipment(id: string){
   ...
   return this.authService.token.pipe(take(1),
    ...
    return this.HttpClient.get<equipmentData>(
      `https://ionic-cab1.firebaseio.com/offered-equipment/${id}.json?auth=${token}`
      );
    }), map( equipData => {
  ...
  delete(id:string){
    return this.authService.token.pipe(take(1),switchMap(token => {
      return this.HttpClient.delete(`https://ionic-cab1.firebaseio.com/offered-equipment/${id}.json?auth=${token}`
  ...
  uploadImage(image : File){
    ...
    return this.authService.token.pipe(
      ...
      return this.HttpClient.post<{imageUrl: string,imagePath: string}>(
        'https://us-central1-ionic-cab1.cloudfunctions.net/storeImage',
  ...
  editOffer(equipmentId:string,title:string,
    ...
    garage:string){
      ...
      return this.HttpClient.put(
        `https://ionic-cab1.firebaseio.com/offered-equipment/${equipmentId}.json?auth=${fetchedToken}`,
