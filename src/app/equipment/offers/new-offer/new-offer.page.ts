...
let imageFile;
    ...
    private showAlert(message:string){
      this.alertCtrl.create({header:'Please note if your images did not upload add them by sliding to edit and select the upload image button and they will load', 
      message:message,
